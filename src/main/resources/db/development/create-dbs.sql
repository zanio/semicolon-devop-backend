...
CREATE TABLE IF NOT EXISTS `alaajo_db`.`admin` (
  ...
  `image_url` VARCHAR(140) NULL DEFAULT NULL,
  ...
  INDEX `fk_saver_application_user1_idx` (`application_user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `alaajo_db`.`bank_details` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_bank_details_saver1_idx` (`saver_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `alaajo_db`.`table_group` (
  ...
  `description` VARCHAR(112) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `alaajo_db`.`password_reset` (
  ...
  PRIMARY KEY (`id`),
  INDEX `password_reset_id` (`id` ASC) VISIBLE,
  INDEX `fk_password_reset_application_user_idx` (`application_user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `alaajo_db`.`saving_target` (
  ...
  `saver_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_saving_target_saver1_idx` (`saver_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `alaajo_db`.`transaction` (
  ...
  INDEX `fk_transaction_user1_idx` (`saver_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `alaajo_db`.`user_activity_log` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_user_activity_log_user1_idx` (`user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `alaajo_db`.`user_investment` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `investment_id_invest_id` INT NOT NULL,
  `user_id_id` INT NOT NULL,
  `start_date` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_user_investment_investment1_idx` (`investment_id_invest_id` ASC) VISIBLE,
  INDEX `fk_user_investment_useadmin_idadmin_idadmin_idr1_idx` (`user_id_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `alaajo_db`.`wallet` (
  ...
  INDEX `fk_wallet_user1_idx` (`saver_id` ASC) VISIBLE,
