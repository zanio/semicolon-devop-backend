...
-- -----------------------------------------------------
-- Schema heroku_d8a9ffdf04c4b36
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `heroku_d8a9ffdf04c4b36`;
...
-- Schema heroku_d8a9ffdf04c4b36
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `heroku_d8a9ffdf04c4b36` DEFAULT CHARACTER SET latin1 ;
USE `heroku_d8a9ffdf04c4b36` ;

-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`application_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`application_user` (
      `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`admin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`admin` (
       ...
       CONSTRAINT `fk_admin_application_user1`
           FOREIGN KEY (`application_user_id`)
               REFERENCES `heroku_d8a9ffdf04c4b36`.`application_user` (`id`)
               ON DELETE NO ACTION
               ON UPDATE NO ACTION)
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`saver`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`saver` (
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`bank_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`bank_details` (
      `id` INT(11) NOT NULL AUTO_INCREMENT,
      ...
      CONSTRAINT `fk_bank_details_saver1`
          FOREIGN KEY (`saver_id`)
              REFERENCES `heroku_d8a9ffdf04c4b36`.`saver` (`id`)
              ON DELETE NO ACTION
              ON UPDATE NO ACTION)
    ENGINE = InnoDB
    DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`investment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`investment` (
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`password_reset`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`password_reset` (
            `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`saving_target`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`saving_target` (
                           `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`saving_plan`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`saving_plan` (
                             `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`transaction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`transaction` (
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`user_activity_log`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`user_activity_log` (
                           `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`user_investment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`user_investment` (
                         `id` INT(11) NOT NULL AUTO_INCREMENT,
                         ...
                         CONSTRAINT `fk_user_investment_investment1`
                             FOREIGN KEY (`investment_id_invest_id`)
                                 REFERENCES `heroku_d8a9ffdf04c4b36`.`investment` (`invest_id`)
                                 ON DELETE NO ACTION
                                 ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`wallet`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`wallet` (
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`table_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`table_group` (
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`group_has_saver`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`group_has_saver` (
                             ...
                             CONSTRAINT `fk_group_has_saver_group1`
                                 FOREIGN KEY (`group_id`)
                                     REFERENCES `heroku_d8a9ffdf04c4b36`.`table_group` (`id`),
...
-- -----------------------------------------------------
-- Table `heroku_d8a9ffdf04c4b36`.`group_invitation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `heroku_d8a9ffdf04c4b36`.`group_invitation` (
  `id` INT NOT NULL AUTO_INCREMENT,
